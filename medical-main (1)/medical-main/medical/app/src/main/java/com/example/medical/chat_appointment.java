...
public class chat_appointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBookAppointmentSlot.setOnClickListener(v -> {
            if (selectedAppointmentSlot != null) {
                ...
                Intent i = new Intent(chat_appointment.this, paymentActivity.class);
                startActivity(i);
            } else {
                Toast.makeText(chat_appointment.this, "Please select a time slot", Toast.LENGTH_SHORT).show();
            }
        });
    }
