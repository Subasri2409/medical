...
public class Direct_visit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBookAppointmentSlot.setOnClickListener(v -> {
            if (selectedAppointmentSlot != null) {
                ...
                Intent i = new Intent(Direct_visit.this, paymentActivity.class);
                startActivity(i);
            } else {
                Toast.makeText(Direct_visit.this, "Please select a time slot", Toast.LENGTH_SHORT).show();
            }
        });
    }
